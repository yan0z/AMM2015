...
<html>
    ...
    <body>
        <div id="content">
            ...
            <div id="contenuti">
                <div class="box">
                    ...
                    <h3>Giardino</h3>
                    <img src="../imgages/giardino.jpg" class="illustrazione" alt="Giardino Villa Serena">
			...
			Altri angoli di giardino richiamano in modo volutamente casuale alle attività produttive, dalla vecchia macina all'erpice posato
			 nei pressi delle siepi di fichi d'india.</p>
                ...
                <div class="box">
                <h3>Camere</h3>
                <img src="../images/camera_rosa2.jpg" class="illustrazione" alt="Camera Rosa Villa Serena">
		...
		<div class="box">
			 <h3>Servizi</h3>
			 <img src="../images/sala_ingresso.jpg" class="illustrazione" alt="Sala di Ingresso Villa Serena">
